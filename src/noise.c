...
const unsigned char PERM[512] = {
    ...
    /* second half duplicated for wrapping */
    151,160,137,91,90,15,
    131,13,201,95,96,53,194,233,7,225,
    140,36,103,30,69,142,8,99,37,240,
    21,10,23,190,6,148,247,120,234,75,
...
float perlin2D(float x, float z) {
  /* find cell coordinates, these will be used for hash corners */
